...
import { TabelaEstoqueTrocasStyles as styles } from './TabelaEstoqueTrocasStyles';
      ...
      { valoresTrocasLojasSemanal.map((valor) => (
        <View style={styles.linhaTabela}>
          ...
          <View style={styles.colunaValor}>
            <Text style={styles.texto}>
              R$ <NumberFormat value={ valor.vlrestoque2 } renderText={value => <Text>{value}</Text>} isNumericString = {true} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} decimalScale={2} fixedDecimalScale={true}/>
            </Text>
          </View>

          <View style={styles.colunaPorcentagem}>
            <Text style={styles.texto}>
              <NumberFormat value={ valor.percestoque2 } renderText={value => <Text>{value}</Text>} isNumericString = {true} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} decimalScale={2} fixedDecimalScale={true}/> %
            </Text>
          </View>
        </View>
      ))}
